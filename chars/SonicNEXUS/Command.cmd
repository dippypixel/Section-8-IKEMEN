...
[State -1, Super Sonic Burst]
type = ChangeState
value = 3100
triggerall = !AIlevel
triggerall = command = "Super Sonic Burst"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 3000, power >= 1000)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6)

[State -1, Hyper Spin Dash Max]
type = ChangeState
value = 3045
triggerall = !AIlevel
triggerall = command = "Hyper Spin Dash Max"
triggerall = RoundState = 2 && StateType != A
...
[State -1, Hyper Spin Dash]
type = ChangeState
value = 3040
triggerall = !AIlevel
triggerall = command = "Hyper Spin Dash"
triggerall = RoundState = 2 && StateType != A
...
value = 3025
triggerall = !AIlevel
triggerall = command = "Hyper Tornado Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6) || var(7)
...
value = 3020
triggerall = !AIlevel
triggerall = command = "Hyper Tornado"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6)

[State -1, Hyper Sonic Wind Max]
type = ChangeState
value = 3005
triggerall = !AIlevel
triggerall = command = "Hyper Sonic Wind Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6) || var(7)
...
[State -1, Hyper Sonic Wind]
type = ChangeState
value = 3000
triggerall = !AIlevel
triggerall = command = "Hyper Sonic Wind"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6)
...
[State -1, Drop Dash Ex]
type = ChangeState
value = 1503
triggerall = !AIlevel
triggerall = command = "Drop Dash Ex"
triggerall=RoundState=2&& statetype=A
...
[State -1, Flash Chop Ex]
type = ChangeState
value = 1453
triggerall = !AIlevel
triggerall = command = "Flash Chop Ex"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Spin Dash Ex]
type = ChangeState
value = 1403
triggerall = !AIlevel
triggerall = command = "Spin Dash Ex"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Homing Attack Air Ex]
type = ChangeState
value = 1153
triggerall = !AIlevel
triggerall = command = "Homing Attack Air Ex"
triggerall=RoundState=2&& statetype=A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2= var(5)

[State -1, Homing Attack Air]
type = ChangeState
value = 1150
triggerall = !AIlevel
triggerall = command = "Homing Attack Air"
triggerall=RoundState=2&& statetype=A
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2= var(5)

[State -1, Homing Attack Ex]
type = ChangeState
value = 1053
triggerall = !AIlevel
triggerall = command = "Homing Attack Ex"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
value = 1050
triggerall = !AIlevel
triggerall = command = "Homing Attack"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Rising Drill Ex]
type = ChangeState
value = 2003
triggerall = !AIlevel
triggerall = command = "Rising Drill Ex"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Rising Drill]
type = ChangeState
value = 2000
triggerall = !AIlevel
triggerall = command = "Rising Drill"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Sonic Wind Ex]
type = ChangeState
value = 1003
triggerall = !AIlevel
triggerall = command = "Sonic Wind Ex"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
trigger4 = stateno = 1403 && movehit && Animelem = 9
trigger5 = stateno = 3040 && movehit && Animelem = 12
...
trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]), 200, 50) * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = stateno = 1450 && movehit && Animelem = 9
trigger4 = stateno = 1453 && movehit && Animelem = 13
trigger5 = stateno = 3020 && movehit && Animelem = 18
...
[State -1, Flash Chop]
type = ChangeState
value = ifElse((var(40) = 0 || var(40) = 3) && Power >= 500 && Random < 133, 1453, 1450)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
...
[State -1, Spin Dash]
type = ChangeState
value = ifElse((var(40) = 0 || var(40) = 3) && Power >= 500 && Random < 133, 1403, 1400)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
[State -1, Homing Attack]
type = ChangeState
value = ifElse((var(40) = 0 || var(40) = 3) && Power >= 500 && Random < 133, 1053, 1050)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
[State -1, Rising Drill]
type = ChangeState
value = ifElse((var(40) = 0 || var(40) = 3) && Power >= 500 && Random < 133, 2003, 2000)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
[State -1, Throw PP Air]
type = ChangeState
value = 950
triggerall = AIlevel && numenemy
triggerall = roundstate = 2 && statetype = A && var(9) != 2
triggerall = !(enemynear, ctrl) && (enemynear, stateno != [120, 155])
triggerall = (p2bodydist x = [-20, 20]) && (p2dist y = [ -40, 60]) && p2statetype != L
trigger1 = ctrl && random < (ifelse(p2dist x < 0, 200, 25) * (AIlevel ** 2 / 64.0))
trigger2 = (stateno = [600, 650])
trigger2 = (movehit = [1, 16]) && (p2bodydist x = [0, 25]) && random < (250 * (AIlevel ** 2 / 64.0))
