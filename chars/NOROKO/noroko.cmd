...
;cr-hp
trigger3 = var(13)=1 && movecontact
;kwaidan
trigger4 = numhelper(1300) != 0
trigger4 = helper(1300), movecontact && stateno = 1301
;suicidio
trigger5 = (stateno = 1000)||(stateno = 1010)
trigger5 = animelemtime(9)>0 && animelemtime(13)<0
;safety
...
;cr-hp
trigger2 = var(13)=1 && movecontact
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movecontact && stateno = 1301
;suicidio
trigger4 = (stateno = 1000)||(stateno = 1010)
trigger4 = animelemtime(9)>0 && animelemtime(13)<0
;safety
...
type = ChangeState
value = 3300
triggerall = command = "funeral"
triggerall = power >= 1000
triggerall = var(10) = 0
triggerall = var(24)= 0
triggerall = roundstate = 2
triggerall = ScreenPos Y >= 70
trigger1 = ctrl
...
;---------------------------------------------------------------------------
; Llanto de Okiku DEBIL
[State -1, Llanto de Okiku]
type = ChangeState
value = 1102
triggerall = command = "okiku1"
triggerall = var(10) = 0
...
;---------------------------------------------------------------------------
; Llanto de Okiku FUERTE
[State -1, Llanto de Okiku]
type = ChangeState
value = 1100
triggerall = command = "okiku2"
triggerall = var(10) = 0
triggerall = statetype != A
triggerall = roundstate=2 
triggerall = var(24)= 0
...
;---------------------------------------------------------------------------
;final sangriento fuerte
[State -1, suicidio]
type = ChangeState
value = 1010
triggerall = command = "suicidio2"
triggerall = var(10) = 0
triggerall = statetype != A
triggerall = roundstate=2 
triggerall = var(24)= 0
...
trigger2 = movecontact
;cr-hp
trigger3 = var(13)=1 && stateno != 1000 && movecontact
;kwaidan
trigger4 = numhelper(1300) != 0
trigger4 = helper(1300), movecontact && stateno = 1301
;safety
...
;---------------------------------------------------------------------------
;final sangriento debil
[State -1, suicidio]
type = ChangeState
value = 1000
triggerall = command = "suicidio1"
triggerall = var(10) = 0
triggerall = statetype != A
triggerall = roundstate=2
triggerall = var(24)= 0
...
type = ChangeState
value = 1200
triggerall = command = "mujer-de-nieve"
triggerall = var(10) = 0
triggerall = roundstate=2
triggerall = ScreenPos Y >= 70
triggerall = var(24) = 0
...
;cuando esta cerca de la pared y lleva ventaja
trigger2 = backedgedist < 4 && p2dist x >= 70 && life > 250 && random <100
;cuando esta cerca de la pared y va perdiendo
trigger3 = backedgedist < 4 && p2dist x < 70 && life <= 250 && random <100
value = 105
...
;kwaidan
trigger4 = numhelper(1300) != 0
trigger4 = helper(1300), movecontact && stateno = 1301 && random < 4
...
value = cond(random<500,1100,1102)

;kwaidan
[State -1,kwaidan]
type = ChangeState
value = cond(random<500,1300,1310)
triggerall = var(24)=4 && roundstate=2 && statetype !=a
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
...
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movecontact && stateno = 1301 && random < 4
...
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movecontact && stateno = 1301 && random < 3
;suicidio
trigger4 = (stateno = 1000)||(stateno = 1010)
trigger4 = animelemtime(9)>0 && animelemtime(13)<0 && random < 3
value = 3000
...
triggerall = ScreenPos Y >= 70
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 100
trigger1 = ctrl && random < 2
;combo chain
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)
trigger2 = movecontact && random < 3
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movecontact && stateno = 1301 && random < 3
...
;combo chain
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 430)||(stateno = 440)
trigger1 = movecontact && random < 5
;kwaidan
trigger2 = numhelper(1300) != 0
trigger2 = helper(1300), movecontact && stateno = 1301 && random < 5
;suicidio
trigger3 = (stateno = 1000)||(stateno = 1010)
trigger3 = animelemtime(9)>0 && animelemtime(13)<0 && random < 5
value = 3500
...
;kwaidan
trigger4 = numhelper(1300) != 0
trigger4 = helper(1300), movecontact && stateno = 1301 && random < 10
value = cond(random<500,1000,1010)
...
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movecontact && stateno = 1301 && random < 10
...
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movecontact && stateno = 1301 && random < 5
;suicidio
trigger4 = (stateno = 1000)||(stateno = 1010)
trigger4 = animelemtime(9)>0 && animelemtime(13)<0 && random < 5
value = 3000
...
trigger2 = movecontact && random < 20
;cr hp
trigger3 = var(13)=1 && random < 20
;kwaidan
trigger4 = numhelper(1300) != 0
trigger4 = helper(1300), movecontact && stateno = 1301 && random < 20
...
trigger2 = p2dist x <= 80 && ctrl && random < 5
;combo chain
...
;suicidio
trigger4 = (stateno = 1000)||(stateno = 1010)
trigger4 = animelemtime(9)>0 && animelemtime(13)<0 && random < 7
;CONTRA ATAQUES ESPECIFICOS
;animus virgen
trigger5 = enemynear, name = "animus" && enemynear, stateno = 3100 && ctrl && random < 5
value = 3200
...
trigger1 = ctrl && random < 3
;p2 salta
trigger2 = enemynear, pos y < -30 && ctrl && random < 5
;combo chain
trigger3 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)
...
;suicidio
trigger5 = (stateno = 1000)||(stateno = 1010)
trigger5 = animelemtime(9)>0 && animelemtime(13)<0 && random < 5
value = 3300
...
;kwaidan
trigger2 = numhelper(1300) != 0
trigger2 = helper(1300), movecontact && stateno = 1301 && random < 10
;suicidio
trigger4 = (stateno = 1000)||(stateno = 1010)
trigger4 = animelemtime(9)>0 && animelemtime(13)<0 && random < 5
value = 3120
...
;kwaidan
trigger2 = numhelper(1300) != 0
trigger2 = helper(1300), movecontact && stateno = 1301 && random < 30
;suicidio
trigger3 = (stateno = 1000)||(stateno = 1010)
trigger3 = animelemtime(9)>0 && animelemtime(13)<0 && random < 20
;CONTRA ATAQUES ESPECIFICOS
;animus virgen
...
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 40 && enemynear,pos y >-110
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 60 && enemynear,pos y >-50
trigger1 = random <60 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 400)||(stateno = 430)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 50 && enemynear,pos y >-60
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 70 && enemynear,pos y >-70
trigger1 = random <100 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 230)||(stateno = 400)||(stateno = 430)||(stateno = 440)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 60 && enemynear,pos y >-30
trigger1 = random <100 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 230)||(stateno = 400)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 70 && enemynear,pos y >-30
...
triggerall = var(24)=3 && roundstate=2 && statetype = a
triggerall = (p2statetype!=L)
trigger1 = p2dist x <= 60 && random <150 && P2Dist Y <= 75 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 630)
trigger2 = movecontact && random <300 && var(25)<=2
...
triggerall = var(24)=3 && roundstate=2 && statetype = a
triggerall = (p2statetype!=L)
trigger1 = p2dist x <= 70 && random <150 && P2Dist Y <= 60 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 600)||(stateno = 630)
trigger2 = movecontact && random <300
...
triggerall = var(24)=3 && roundstate=2 && statetype = a
triggerall = (p2statetype!=L)
trigger1 = p2dist x <= 60 && random <150 && P2Dist Y <= 60 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 600)
trigger2 = movecontact && random <300 && var(25)<=2
...
triggerall = var(24)=3 && roundstate=2 && statetype = a
triggerall = (p2statetype!=L)
trigger1 = p2dist x <= 70 && random <150 && P2Dist Y <= 110 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 600)||(stateno = 610)||(stateno = 630)
trigger2 = movecontact && random <300
...
trigger1 = ctrl && random < (cond(life>250,5,25))
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 430)||(stateno = 440)
trigger2 = movehit && random < 120
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movehit && stateno = 1301 && random < 30 && animelemtime(10)>=0
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
trigger4 = enemynear, name = "animus" && enemynear, stateno = 1200 && ctrl && random < 7
;noroko decoy
trigger5 = enemynear, name = "noroko" && enemynear, stateno = 1100 && ctrl && random < 7
;viuda SUPER tela - deja de correr en common
...
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
trigger1 = p2dist x <= 100 && ctrl && random < 2 && p2movetype != h
;p2 ataca
trigger2 = p2dist x <= 100 && ctrl && random < 5 && p2movetype = a
value = cond(random<500,1100,1102)
...
;p2 salta
trigger2 = enemynear, pos y < -40
trigger2 = p2dist x <= 80 && ctrl && random < 20
;combo chain
trigger3 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)
trigger3 = movehit && random < 90 && p2dist x <= 100
;kwaidan
trigger4 = numhelper(1300) != 0
trigger4 = helper(1300), movehit && stateno = 1301 && random < 30 && animelemtime(7)<0
;CONTRA ATAQUES ESPECIFICOS
;noroko mujer de nieve
trigger5 = enemynear, name = "noroko" && enemynear, stateno = 1210 && ctrl && random < 30
...
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 430)
trigger2 = movehit && random < 15
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movehit && stateno = 1301 && random < 15
;suicidio
trigger4 = (stateno = 1000)||(stateno = 1010)
trigger4 = animelemtime(9)>0 && animelemtime(13)<0 && random < 15
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a && power >= 1000
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 150 && enemynear,pos y >-100
;combo chain 1
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 430)||(stateno = 440)
trigger1 = movehit && random < 15
;kwaidan
trigger2 = numhelper(1300) != 0
trigger2 = helper(1300), movehit && stateno = 1301 && random < 15 && animelemtime(10)>0
;suicidio
trigger3 = (stateno = 1000)||(stateno = 1010)
trigger3 = animelemtime(9)>0 && animelemtime(13)<0 && random < 15
;CONTRA ATAQUES ESPECIFICOS
;animus virgen
trigger4 = enemynear, name = "animus" && enemynear, stateno = 3100 && ctrl && random < 6
value = 3200
...
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 100
;p2 salta
trigger1 = enemynear, pos y < -30 && ctrl && random < 3
;combo chain
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)
trigger2 = movehit && random < 15
;kwaidan
trigger3 = numhelper(1300) != 0
trigger3 = helper(1300), movehit && stateno = 1301 && random < 15 && animelemtime(7)<0
;suicidio
trigger4 = (stateno = 1000)||(stateno = 1010)
trigger4 = animelemtime(9)>0 && animelemtime(13)<0 && random < 15
value = 3300
...
;kwaidan
trigger2 = numhelper(1300) != 0
trigger2 = helper(1300), movehit && stateno = 1301 && random < 60 && animelemtime(10)>0
;suicidio
trigger3 = (stateno = 1000)||(stateno = 1010)
trigger3 = animelemtime(9)>0 && animelemtime(13)<0 && random < 60
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
