...
triggerall= cond(enemy,numpartner,enemy(0),life <330 ||enemy(1),life<330,enemy,life <330)
triggerall = var(10)=0
...
;cancel dementia 13 debil
trigger3 = stateno = 2110 && movecontact && animelemtime(27) < 0
;cancel dementia 13 fuerte
trigger4 = stateno = 2100 && movecontact && animelemtime(39) < 0
;cancel ascenso cruel
trigger5 = stateno = 1050 && movecontact
;cancel telecortes
trigger6 = stateno = 2010 && movecontact; && animelemtime(2)<=15
;cancel cuchillos 1
trigger7 = stateno = 900 && (animelemtime(5)=[1,8])
;cancel cuchillos 2
trigger8 = stateno = 902 && (animelemtime(4)=[1,8])
;safety
trigger9 = (stateno=[200,440]) && time <3
...
triggerall = var(10) = 0
triggerall = var(24)=0
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger1 = movecontact
;cancel dementia 13 debil
trigger2 = stateno = 2110 && movecontact && animelemtime(27) < 0
;cancel dementia 13 fuerte
trigger3 = stateno = 2100 && movecontact && animelemtime(39) < 0
;cancel ascenso cruel
trigger4 = stateno = 1050 && movecontact
;cancel telecortes
trigger5 = stateno = 2010 && movecontact; && animelemtime(2)<=15
;cancel cuchillos 1
trigger6 = stateno = 900 && (animelemtime(5)=[1,8])
;cancel cuchillos 2
trigger7 = stateno = 902 && (animelemtime(4)=[1,8])
;safety
trigger8 = (stateno=[200,440]) && time <3

;-----------------------------------------------------------------------------
;Tajada crítica
[State -1, super puñalada]
type = ChangeState
value = 3050
triggerall = command = "super_puñalada"
...
;;---------------------------------------------------------------------------
;5 chances de morir (uses one super bar)
[State -1, super lanzamiento]
type = ChangeState
value = 3060
triggerall = command = "super_lanzamiento"
triggerall = var(10) = 0
triggerall = power >= 1000
triggerall = var(10) = 0
triggerall = var(24)=0
...
;---------------------------------------------------------------------------
;Deleite escarlata (uses one super bar)
[State -1, cirugia]
type = ChangeState
value = 3070
triggerall = command = "cirugia"
triggerall = power >= 1000
triggerall = statetype != A
triggerall = var(10) = 0
triggerall = var(24)=0
...
triggerall = var(24)=0
trigger1 = ctrl
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)||(stateno = 640)
trigger2 = movecontact
;safety
trigger3 = (stateno=[200,440]) && time <3
...
;---------------------------------------------------------------------------
;puñalada vital aereo derecho
[State -1, lanzamiento aereo 1]
type = ChangeState
value = 904
triggerall = command = "lanza"
triggerall = var(10) = 0
triggerall = var(5) = 0
triggerall = var(24)=0
...
trigger1 = statetype != S
trigger1 = ctrl
trigger2 = (stateno = 240)||(stateno = 600)||(stateno = 610)||(stateno = 630)||(stateno = 640)
trigger2 = movecontact
;safety
trigger3 = (stateno=[200,440]) && time <3

;---------------------------------------------------------------------------
;puñalada vital aereo abajo
[State -1, lanzamiento aereo 2]
type = ChangeState
value = 906
triggerall = command = "lanza2"
triggerall = var(10) = 0
triggerall = var(5) = 0
triggerall = var(24)=0
trigger1 = statetype != C
...
;---------------------------------------------------------------------------
;puñalada vital derecho
[State -1, lanzamiento 1]
type = ChangeState
value = 900
triggerall = command = "lanza"
triggerall = var(10) = 0
...
;---------------------------------------------------------------------------
;puñalada vital hacia arriba
[State -1, lanzamiento 2]
type = ChangeState
value = 902
triggerall = command = "lanza2"
triggerall = var(10) = 0
...
trigger2 = time > 6
trigger3 = (stateno = 230)||(stateno = 400)||(stateno = 430)
trigger3 = movecontact && var(25)<=2
...
trigger1 = statetype = C
trigger1 = ctrl
trigger2 = (stateno = 200)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)
trigger2 = movecontact
...
[State -1]
type = ChangeState
value = cond(random<500,1060,1050)
triggerall = var(24)=4 && roundstate=2 && statetype !=a
...
triggerall = var(5) = 0
trigger1 = p2dist x >= 70 && ctrl
trigger1 = random < 2 && enemynear, statetype = a
;combo chain
trigger2 = (stateno = 240)||(stateno = 600)||(stateno = 610)||(stateno = 630)||(stateno = 640)
trigger2 = movecontact && random < 4
...
[State -1]
type = ChangeState
triggerall = var(24)=4 && roundstate=2
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
trigger1 = p2dist x <= 120 && ctrl && random < 2
;combo chain
...
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger2 = movecontact && random < 4
value = cond(random<500,2100,2110)
...
;cancel dementia 13 debil
trigger3 = stateno = 2110 && movecontact && animelemtime(27) < 0 && random < 2
;cancel dementia 13 fuerte
trigger4 = stateno = 2100 && movecontact && animelemtime(39) < 0 && random < 2
;cancel ascenso cruel
trigger5 = stateno = 1050 && movecontact && random < 2
;cancel telecortes
trigger6 = stateno = 2010 && movecontact && random < 2; && animelemtime(2)<=15
;cancel cuchillos 1
trigger7 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 2
;cancel cuchillos 2
trigger8 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 2
value = 3050
...
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) 
trigger1 = p2dist x >= 70 && ctrl && random = 1
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger2 = movecontact && random < 2
;cancel dementia 13 debil
...
trigger5 = stateno = 1050 && movecontact && random < 2
;cancel telecortes
trigger6 = stateno = 2010 && movecontact && random < 2; && animelemtime(2)<=15 && random < 2
;cancel cuchillos 1
trigger7 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 2
;cancel cuchillos 2
trigger8 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 2
...
;cancel dementia 13 debil
trigger2 = stateno = 2110 && movecontact && animelemtime(27) < 0 && random < 3
;cancel dementia 13 fuerte
trigger3 = stateno = 2100 && movecontact && animelemtime(39) < 0 && random < 3
;cancel ascenso cruel
trigger4 = stateno = 1050 && movecontact && random < 5
;cancel telecortes
trigger5 = stateno = 2010 && movecontact && random < 2;&& animelemtime(2)<=15 && random < 5
;cancel cuchillos 1
trigger6 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 5
;cancel cuchillos 2
trigger7 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 5
value = 4000
...
triggerall = var(5) = 0
trigger1 = p2dist x >= 70 && ctrl
trigger1 = random < 4 && enemynear, statetype = a
;combo chain
trigger2 = (stateno = 240)||(stateno = 600)||(stateno = 610)||(stateno = 630)||(stateno = 640)
trigger2 = movecontact && random < 10
...
[State -1]
type = ChangeState
triggerall = var(24)=1 && roundstate=2
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
trigger1 = p2dist x <= 120 && ctrl && random < 3
;combo chain
...
;cancel dementia 13 debil
trigger3 = stateno = 2110 && movecontact && animelemtime(27) < 0 && random < 3
;cancel dementia 13 fuerte
trigger4 = stateno = 2100 && movecontact && animelemtime(39) < 0 && random < 3
;cancel ascenso cruel
trigger5 = stateno = 1050 && movecontact && random < 5
;cancel telecortes
trigger6 = stateno = 2010 && movecontact && random < 5;&& animelemtime(2)<=15 && random < 5
;cancel cuchillos 1
trigger7 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 5
;cancel cuchillos 2
trigger8 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 5
value = 3050
...
trigger4 = stateno = 1050 && movecontact && random < 5
;cancel telecortes
trigger5 = stateno = 2010 && movecontact && random < 5;&& animelemtime(2)<=15 && random < 5
;cancel cuchillos 1
trigger6 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 5
;cancel cuchillos 2
trigger7 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 5
...
triggerall = var(24)=2 && roundstate=2 && statetype = a
triggerall = (p2statetype!=L)
trigger1 = p2dist x <= 80 && random <30 && ctrl
;combo chain 1
trigger2 = (stateno = 600)||(stateno = 610)||(stateno = 630)
trigger2 = movecontact && random <20
...
[State -1]
type = ChangeState
value = cond(random<500,1050,1060)
triggerall = var(24)=2 && roundstate=2 && statetype !=a
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
...
trigger5 = enemynear, name = "ananzi" && enemynear, numhelper(1100)=1 && ctrl && random < 5
...
trigger1 = enemynear, statetype = a && enemynear, vel y < 0
;p2 volando
trigger2 = p2dist x >= 100 && ctrl && random < 5
trigger2 = enemynear, pos y <= -15 && enemynear, vel y = 0
;combo chain 1
trigger3 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger3 = movecontact && random < 20
...
triggerall = var(5) = 0
trigger1 = p2dist x >= 70 && ctrl
trigger1 = random < 7 && enemynear, statetype = a
;combo chain
trigger2 = (stateno = 240)||(stateno = 600)||(stateno = 610)||(stateno = 630)||(stateno = 640)
trigger2 = movecontact && random < 20
...
trigger3 = enemynear, name = "ananzi" && enemynear, stateno = 3100 && ctrl && random < 5

;tele corte cerca
[State -1]
type = ChangeState
triggerall = var(24)=2 && roundstate=2
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
trigger1 = p2dist x <= 120 && ctrl && random < 5
;combo chain
...
;cancel dementia 13 debil
trigger4 = stateno = 2110 && movecontact && animelemtime(39) < 0 && random < 8
;cancel dementia 13 fuerte
trigger5 = stateno = 2100 && movecontact && animelemtime(39) < 0 && random < 8
;cancel ascenso cruel
trigger6 = stateno = 1050 && movecontact && random < 10
;cancel telecortes
trigger7 = stateno = 2010 && movecontact && random < 10;animelemtime(2)<=15 && random < 10
;cancel cuchillos 1
trigger8 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 10
;cancel cuchillos 2
trigger9 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 10
value = 3050
...
;p2 salta
trigger2 = p2dist x <= 200 && ctrl && random < 2
trigger2 = enemynear, statetype = a && enemynear, vel y < 0
;combo chain 1
trigger3 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger3 = movecontact && random < 10
...
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
trigger10 = enemynear, name = "animus" && enemynear, stateno = 1200 && ctrl && random < 5
;noroko decoy
trigger11 = enemynear, name = "noroko" && enemynear, stateno = 1100 && ctrl && random < 5
;viuda tela - deja de correr en common
trigger12 = enemynear, name = "ananzi" && enemynear, numhelper(1100)=1 && ctrl && random < 5
;viuda SUPER tela - deja de correr en common
trigger13 = enemynear, name = "ananzi" && enemynear, stateno = 3100 && ctrl && random < 5
value = 3060
...
trigger2 = movecontact && random < 10
;cancel dementia 13 debil
trigger3 = stateno = 2110 && movecontact && animelemtime(39) < 0 && random < 8
;cancel dementia 13 fuerte
trigger4 = stateno = 2100 && movecontact && animelemtime(39) < 0 && random < 8
;cancel ascenso cruel
trigger5 = stateno = 1050 && movecontact && random < 10
;cancel telecortes
trigger6 = stateno = 2010 && movecontact && random < 10;&& animelemtime(2)<=15 && random < 10
;cancel cuchillos 1
trigger7 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 10
;cancel cuchillos 2
trigger8 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 10
;CONTRA ATAQUES ESPECIFICOS
;animus virgen
trigger9 = enemynear, name = "animus" && enemynear, stateno = 3100 && ctrl && random < 5
value = 3070
...
;cancel dementia 13 debil
trigger2 = stateno = 2110 && movecontact && animelemtime(39) < 0 && random < 8
;cancel dementia 13 fuerte
trigger3 = stateno = 2100 && movecontact && animelemtime(39) < 0 && random < 8
;cancel ascenso cruel
trigger4 = stateno = 1050 && movecontact && random < 10
;cancel telecortes
trigger5 = stateno = 2010 && movecontact && random < 10;&& animelemtime(2)<=15 && random < 10
;cancel cuchillos 1
trigger6 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 10
;cancel cuchillos 2
trigger7 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 10
value = 3110
...
;combo chain 1
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger1 = movecontact && random < 60
;cancel dementia 13 debil
trigger2 = stateno = 2110 && movecontact && animelemtime(39) < 0 && random < 8
;cancel dementia 13 fuerte
trigger3 = stateno = 2100 && movecontact && animelemtime(39) < 0 && random < 8
...
trigger4 = stateno = 1050 && movecontact && random < 10
;cancel telecortes
trigger5 = stateno = 2010 && movecontact && random < 2;&& animelemtime(2)<=15 && random < 10
;cancel cuchillos 1
trigger6 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 10
;cancel cuchillos 2
trigger7 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 10
;CONTRA ATAQUES ESPECIFICOS
;animus virgen
trigger8 = enemynear, name = "animus" && enemynear, stateno = 3100 && ctrl && random < 20
value = 4000
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 40 && enemynear,pos y >-80
trigger1 = random <60 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 400)||(stateno = 430)
...
;combo chain 1
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 430)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 50 && enemynear,pos y >-70
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 80 && enemynear,pos y >-70
trigger1 = random <100 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 230)||(stateno = 400)||(stateno = 430)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 40 && enemynear,pos y >-70
trigger1 = random <100 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 230)||(stateno = 400)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 80 && enemynear,pos y >-40
...
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
trigger3 = enemynear, name = "animus" && enemynear, stateno = 1200 && ctrl && random < 10
;noroko decoy
trigger4 = enemynear, name = "noroko" && enemynear, stateno = 1100 && ctrl && random < 10
;viuda tela - deja de correr en common
trigger5 = enemynear, name = "ananzi" && enemynear, numhelper(1100)=1 && ctrl && random < 20
...
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
;p2 salta
trigger1 = p2dist x >= 100 && ctrl && random < 20
trigger1 = enemynear, statetype = a && enemynear, vel y < 0
;p2 volando
trigger2 = p2dist x >= 100 && ctrl && random < 20
trigger2 = enemynear, pos y <= -15 && enemynear, vel y = 0
;combo chain 1
trigger3 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger3 = movecontact && random < 100

;puñalada vital aereo derecho
[State -1, lanzamiento aereo 1]
type = ChangeState
value = 904
triggerall = var(24)=3 && roundstate=2 && statetype = a && pos y >-40
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155])
triggerall = var(5) = 0
trigger1 = p2dist x >= 70 && ctrl
...
;CONTRA ATAQUES ESPECIFICOS
;viuda SUPER tela - deja de correr en common
trigger3 = enemynear, name = "ananzi" && enemynear, stateno = 3100 && ctrl && random < 20

;tele corte cerca
[State -1]
type = ChangeState
triggerall = var(24)=3 && roundstate=2
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
;CONTRA ATAQUES ESPECIFICOS (NO LO HACE)
;animus decoy
triggerall = enemynear, stateno != 1200
;noroko decoy
triggerall = enemynear, stateno != 1100
;viuda tela
triggerall = enemynear, numhelper(1100)=0 
;animus virgen
triggerall = enemynear, stateno != 3100
trigger1 = p2dist x <= 120 && ctrl && random < 5
;combo chain
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)||(stateno = 640)
...
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 120 && enemynear,pos y >-140 
;combo chain 1
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger1 = movehit && random < 7
;cancel dementia 13 debil
trigger2 = stateno = 2110 && movehit && animelemtime(17) > 0 && animelemtime(27) < 0 && random < 4
;cancel dementia 13 fuerte
trigger3 = stateno = 2100 && movehit && animelemtime(29) > 0 && animelemtime(39) < 0 && random < 4
;cancel ascenso cruel
trigger4 = stateno = 1050 && movehit && random < 8
;cancel telecortes
trigger5 = stateno = 2010 && movehit && random < 7;animelemtime(2)<=15 && random < 7
;cancel cuchillos 1
trigger6 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 7
;cancel cuchillos 2
trigger7 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 7
value = 3050
...
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger2 = movehit && random < 7
;cancel dementia 13 debil
trigger3 = stateno = 2110 && movehit && animelemtime(17) > 0 && animelemtime(27) < 0 && random < 4
;cancel dementia 13 fuerte
trigger4 = stateno = 2100 && movehit && animelemtime(29) > 0 && animelemtime(39) < 0 && random < 4
;cancel ascenso cruel
trigger5 = stateno = 1050 && movehit && random < 8
;cancel telecortes
trigger6 = stateno = 2010 && movehit && random < 7;&& animelemtime(2)<=15 && random < 7
;cancel cuchillos 1
trigger7 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 7
;cancel cuchillos 2
trigger8 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 7
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
trigger9 = enemynear, name = "animus" && enemynear, stateno = 1200 && ctrl && random < 10
;noroko decoy
trigger10 = enemynear, name = "noroko" && enemynear, stateno = 1100 && ctrl && random < 10
;viuda tela - deja de correr en common
trigger11 = enemynear, name = "ananzi" && enemynear, numhelper(1100)=1 && ctrl && random < 20
;viuda SUPER tela - deja de correr en common
trigger12 = enemynear, name = "ananzi" && enemynear, stateno = 3100 && ctrl && random < 20
value = 3060
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a && power >= 1000
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 150 && enemynear,pos y >-70 
;combo chain 1
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger1 = movehit && random < 6
;cancel dementia 13 debil
trigger2 = stateno = 2110 && movehit && animelemtime(17) > 0 && animelemtime(27) < 0 && random < 4
;cancel dementia 13 fuerte
trigger3 = stateno = 2100 && movehit && animelemtime(29) > 0 && animelemtime(39) < 0 && random < 4
...
trigger4 = stateno = 1050 && movehit && random < 8
;cancel telecortes
trigger5 = stateno = 2010 && movehit && animelemtime(2)<=15 && random < 7
;cancel cuchillos 1
trigger6 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 7
;cancel cuchillos 2
trigger7 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 7
...
type = ChangeState
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = power >= 3000 && p2dist x <= 90
triggerall = var(10) = 0
triggerall= numenemy=1
triggerall= enemy,life<=330
;combo chain 1
...
trigger4 = stateno = 1050 && movehit && random < 8
;cancel cuchillos 1
trigger5 = stateno = 900 && (animelemtime(5)=[1,8]) && random < 7
;cancel cuchillos 2
trigger6 = stateno = 902 && (animelemtime(4)=[1,8]) && random < 7
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
trigger7 = enemynear, name = "animus" && enemynear, stateno = 1200 && ctrl && random < 80
;noroko decoy
trigger8 = enemynear, name = "noroko" && enemynear, stateno = 1100 && ctrl && random < 80
;animus virgen
trigger9 = enemynear, name = "animus" && enemynear, stateno = 3100 && ctrl && random < 80
value = 4000
