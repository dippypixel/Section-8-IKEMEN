...
;cancela boomerang
trigger3 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0
;safety
...
;cancela boomerang
trigger2 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0
;safety
...
triggerall = NumHelper(3103) = 0
triggerall = NumHelper(3104) = 0
...
;;---------------------------------------------------------------------------
;HYPER BOOMERANG
[State -1, hyper boomerang]
type = ChangeState
value = 3600
triggerall = command = "hyperboomerang"
triggerall = var(10) = 0
triggerall = power >= 1000
triggerall = var(24)=0
trigger1 = statetype != A
...
;---------------------------------------------------------------------------
;HYPER sierra (uses one super bar)
[State -1, hyper sierra]
type = ChangeState
value = 3500
triggerall = command = "hypersierra"
triggerall = power >= 1000
triggerall = var(10) = 0
triggerall = var(24)=0
trigger1 = ctrl
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 630)
trigger2 = movecontact
trigger3 = stateno = 610 && movecontact && var(17)<2
;cancela con sierra
trigger4 = numhelper(1060)=1 && helper(1060),movecontact && helper(1060),animelemtime(36)<0
;cancela boomerang
trigger5 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0
;safety
...
[State -1, cuchilla giratoria 1]
type = ChangeState
value = 1050
triggerall = command = "sierra1"
triggerall = var(10) = 0
triggerall = var(24)=0
;trigger1 = statetype != A
trigger1 = ctrl
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)
trigger2 = movecontact
;safety
trigger3 = (stateno=[200,440]) && time <3
...
[State -1, cuchilla giratoria 2]
type = ChangeState
value = 1051
triggerall = command = "sierra2"
triggerall = var(10) = 0
triggerall = var(24)=0
;trigger1 = statetype != A
trigger1 = ctrl
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = 200)||(stateno = 240)||(stateno = 230)||(stateno = 400)||(stateno = 430)
trigger2 = movecontact
...
trigger1 = p2dist x > 60 && random < 7 && enemynear, movetype !=a
value = 100
...
[State -1, sierra]
type = ChangeState
value = cond(random<500,1050,1051)
triggerall = var(24)=4 && roundstate=2; && statetype !=a
...
triggerall = var(10) = 0
trigger1 = p2dist x >= 100 && p2dist x <= 160 && ctrl && random < 2
value = 2000
...
triggerall = var(10) = 0
trigger1 = p2dist x >= 160 && ctrl && random < 2
value = 2001
...
[State -1, hyper sierra]
type = ChangeState
triggerall = var(24)=4 && roundstate=2 && power >= 1000
triggerall = var(10) = 0
...
trigger3 = helper(1060),movecontact && helper(1060),animelemtime(36)<0 && random < 3
;cancela boomerang
trigger4 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && random < 3
value = 3500
...
trigger2 = movecontact && random < 3
;cancela boomerang
trigger3 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && random < 3
value = 3600


;hyper clones
[State -1, hyper clones]
type = ChangeState
triggerall = var(24)=4 && roundstate=2 && statetype !=a && power >= 1000
triggerall = var(10) = 0
triggerall = NumHelper(3101) = 0
...
;cancela boomerang
trigger2 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && random < 5
value = 4000
...
triggerall = (p2stateno!=[120,155]) && p2movetype != a
triggerall = var(10) = 0
trigger1 = p2dist x >= 100 && p2dist x <= 160 && ctrl && random < 3
value = 2000
...
triggerall = (p2statetype!=L) && p2movetype != a
triggerall = var(10) = 0
trigger1 = p2dist x >= 160 && ctrl && random < 3
value = 2001
...
[State -1, hyper sierra]
type = ChangeState
triggerall = var(24)=1 && roundstate=2 && power >= 1000
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 120
...
;cancela con sierra
trigger3 = numhelper(1060)=1
trigger3 = helper(1060),movecontact && helper(1060),animelemtime(36)<0 && random < 5
;cancela boomerang
trigger4 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && random < 5
value = 3500
...
trigger2 = movecontact && random < 5
;cancela boomerang
trigger3 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && random < 5
value = 3600
...
;no hace dark force en este nivel basico de AI
...
trigger1 = p2dist x >= 100 && p2dist x <= 160 && ctrl && random < 5
value = 1100
...
trigger1 = p2dist x >= 160 && ctrl && random < 5
value = 2001
...
[State -1, hyper sierra]
type = ChangeState
triggerall = var(24)=2 && roundstate=2 && power >= 1000
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 120
trigger1 = ctrl && random < 4
;cuando p2 salta
trigger2 = enemynear, statetype = a && enemynear, vel y < 0
trigger2 = p2dist x <= 140 && ctrl && random < 5
;combo chain 1
trigger3 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)||(stateno = 600)||(stateno = 610)||(stateno = 630)
trigger3 = movecontact && random < 10
;cancela con sierra
trigger4 = numhelper(1060)=1
trigger4 = helper(1060),movecontact && helper(1060),animelemtime(36)<0 && random < 10
;cancela boomerang
trigger5 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && random < 10
value = 3500
...
trigger3 = movecontact && random < 10
;cancela boomerang
trigger4 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && random < 10
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
...
;viuda tela - deja de correr en common
trigger7 = enemynear, name = "ananzi" && enemynear, numhelper(1100)=1 && ctrl && random < 5
;viuda SUPER tela - deja de correr en common
trigger8 = enemynear, name = "ananzi" && enemynear, stateno = 3100 && ctrl && random < 5
value = 3600
...
triggerall = NumHelper(3104) = 0
triggerall = NumHelper(3105) = 0
trigger1 = p2dist x >= 110 && p2movetype != a && ctrl && random < 5
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
...
;cancela boomerang
trigger2 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && p2dist x <= 100 && random < 10
value = 3705
...
;cancela boomerang
trigger2 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && p2dist x <= 160 && random < 30
;CONTRA ATAQUES ESPECIFICOS
;animus virgen
...
;CONTRA ATAQUES ESPECIFICOS
;noroko df
trigger3 = enemynear, name = "noroko" && enemynear, var(10)!=0 && ctrl && random < 300 && p2bodydist X < 70
;crouch light punch
;shar-makai df
trigger4 = enemynear, name = "shar-makai" && enemynear, var(10)!=0 && ctrl && random < 300 && p2bodydist X < 70
...
triggerall = var(24)=3 && roundstate=2 && statetype = a
triggerall = (p2statetype!=L)
trigger1 = p2dist x <= 80 && random <50 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 600)||(stateno = 630)
trigger2 = movecontact && random <300
...
;cuando p2 salta
trigger3 = enemynear, statetype = a
trigger3 = p2dist x <= 150 && ctrl && enemynear, vel x >0 && random < 10
...
trigger2 = movecontact && random < 120 && p2dist x <= 80
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
...
trigger2 = enemynear, pos y <= -15 && enemynear, vel x > 0
;p2 golpeado por bomba lejos
trigger3 = numhelper(2001)=1
trigger3 = p2dist x >= 120 && ctrl && random < 30
trigger3 = helper(2001), anim = 2002 && p2movetype = H && numhelper(2000)=0
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2stateno!=[120,155]) && p2movetype != a
triggerall = var(10) = 0 && ctrl
triggerall = numhelper(2000)=0
trigger1 = p2dist x >= 100 && p2dist x <= 160 && random < 4
;combo con bomba lejos
trigger2 = prevstateno = 2001 && time < 10 && random < 100
value = 2000
...
triggerall = var(10) = 0
triggerall = numhelper(2001)=0
trigger1 = p2dist x >= 160 && ctrl && random < 10
;noroko en el techo
trigger2 = enemynear, name = "noroko" && enemynear, stateno = 1210 && ctrl && p2dist x >= 130 && random < 40
value = 2001
...
[State -1, hyper sierra]
type = ChangeState
triggerall = var(24)=3 && roundstate=2 && power >= 1000
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
trigger1 = ctrl && p2dist x <= 120 && random < 2
;cuando p2 salta
trigger2 = enemynear, statetype = a && enemynear, vel y < 0
trigger2 = p2dist x <= 140 && ctrl && random < 3
;combo chain 1
trigger3 = (stateno = 210)||(stateno = 240)||(stateno = 410)||(stateno = 440)||(stateno = 610)
trigger3 = movecontact && random < 10
;cancela con sierra
trigger4 = numhelper(1060)=1
trigger4 = helper(1060),movecontact && helper(1060),animelemtime(36)<0 && random < 10
;cancela boomerang 1
trigger5 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && numhelper(900) && helper(900),movehit && p2dist x <= 90 && random < 50
;pega bomba cerca
trigger6 = numhelper(2000)=1
trigger6 = ctrl && helper(2000), movehit && enemynear, vel Y < 0 && p2dist x <= 100 && random <50
value = 3500
...
trigger1 = p2dist x >= 70 && ctrl && random = 1
;p2 salta
trigger2 = p2dist x <= 200 && ctrl && random = 1
trigger2 = enemynear, statetype = a && enemynear, vel y < 0
;combo chain 1
trigger3 = (stateno = 200)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)
trigger3 = movecontact && random < 10
;cancela boomerang 1
trigger4 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && numhelper(900) && helper(900),movehit && p2dist x <= 90 && random < 50
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
trigger5 = enemynear, name = "animus" && enemynear, stateno = 1200 && ctrl && random < 10
;noroko decoy
trigger6 = enemynear, name = "noroko" && enemynear, stateno = 1100 && ctrl && random < 10
;viuda tela - deja de correr en common
...
;pega bomba cerca
trigger9 = numhelper(2000)=1
trigger9 = ctrl && helper(2000), movehit && enemynear, vel Y < 0 && random <50
value = 3600
...
triggerall = var(10) = 0
trigger1 = p2dist x >= 110 && p2movetype != a && ctrl && random = 1
value = 3700
...
triggerall = var(10) = 0
;combo chain 1
trigger1 = (stateno = 210)||(stateno = 240)||(stateno = 410)||(stateno = 440)||(stateno = 610)
trigger1 = movecontact && random < 6
;cancela boomerang 1
trigger2 = anim = 901 && animelemtime(6)>0 && animelemtime(7)<0 && numhelper(900) && helper(900),movehit && p2dist x <= 90 && random < 10
value = 3705
...
triggerall= enemy,life<=330
;combo chain 1
trigger1 = (stateno = 200)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)
trigger1 = movecontact && random < 200
;pega bomba cerca
trigger2 = numhelper(2000)=1
trigger2 = ctrl && helper(2000), movehit && enemynear, vel Y < 0 && random <200
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
