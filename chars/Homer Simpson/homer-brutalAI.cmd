...
trigger3 = stateno = 210 || (stateno = 215 && var(13) = 1) || stateno = 410 || stateno = 420
trigger4 = Stateno = 3101 && AnimElem = 33
trigger4 =  Random >= P2Life
trigger5 = stateno = 3120 || Stateno = 3667
...
triggerall = var(39) = 1
triggerall = var(7) = 1
trigger1 = P2Life < 250 || Life < 750 && P2Life < 750 && random > life
...
trigger1 = random > 857 | random > life && life < 750
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100 || StateNo = 40)
trigger1 = P2MoveType != H || P2MoveType = H && Random > 500
trigger2 = Var(12) = [1,10]
trigger2 = (stateno = [200,205)) || stateno = 235 || stateno = 400 || stateno = 430
trigger3 = Var(12) = [1,16]
trigger3 = stateno = 210 || (stateno = 215 && var(13) = 1) || stateno = 410 || stateno = 420
...
value = 4400
triggerall= NumHelper(3008) = 0 && NumHelper(3009) = 0 && NumHelper(3010) = 0
triggerall= Var(17) = 0 && var(39) = 0 && (Command = "Misogi Butt" && Power >= 4000)
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100 || StateNo = 40)
trigger2 = Var(12) = [1,10]
trigger2 = (stateno = [200,205)) || stateno = 235 || stateno = 400 || stateno = 430
trigger3 = Var(12) = [1,16]
...
trigger4 = Stateno = 1110  && HitDefAttr = S, SA
;---------------------------------------------------------------------
...
triggerall= var(39) = 0
triggerall= Power >= 2000
triggerall= Command = "Ready Aim Fire"
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100 || StateNo = 40)
...
type = ChangeState
value = 3667
triggerall= Command = "Grim Reaper"
triggerall = Power >= 2000
triggerall = var(39)
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100 || StateNo = 40)
trigger2 = Var(12) = [1,10]
...
trigger5 = Stateno = 3101
;---------------------------------------------------------------------
[State -1, Hyper Homer Goku]
type = ChangeState
value = 3700
triggerall = command = "Homer Goku"
triggerall = power >= 2000 
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100 || StateNo = 40)
trigger2 = Var(12) = [1,10]
trigger2 = (stateno = [200,205)) || stateno = 235 || stateno = 400 || stateno = 430
...
;=====================================================================
;---------------------------------------------------------------------
[State -1, Bart Sling-Shot]
type = ChangeState
value = 1500
triggerall= NumHelper(3008) = 0 && NumHelper(3009) = 0 && NumHelper(3010) = 0
triggerall = var(39) = 0 && Command = "Sling-Shot" && NumProjID(1005) = 0
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100)
;---------------------------------------------------------------------
[State -1, Side Switch]
type = ChangeState
...
triggerall= Var(39) = 0
triggerall= NumHelper(3008) = 0 && NumHelper(3009) = 0 && NumHelper(3010) = 0
triggerall= Var(17) = 0 && Command = "Gun Spree" && NumProjID(1005) = 0
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100)
trigger2 = Var(12) = [1,10]
trigger2 = (stateno = [200,205)) || stateno = 235 || stateno = 400 || stateno = 430
trigger3 = Var(12) = [1,16]
...
trigger1 = Command = "fwd_y" && P2BodyDist X < 10 || Command = "fwd_b" && P2BodyDist X < 10
trigger2 = Command = "back_y" && P2BodyDist X < 10 || Command = "back_b" && P2BodyDist X < 10
;---------------------------------------------------------------------
[State -1, Crawling Dodge Backward]
type = ChangeState
value = 4001
Triggerall = Anim = 21 || Anim = 10021
triggerall = Command = "recovery"
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100)
trigger2 = Time <= 1 && ((StateNo = [200,499]) ||  (StateNo = 700))
;---------------------------------------------------------------------
[State -1, Crawling Dodge Forward]
type = ChangeState
value = 4000
triggerall = Command = "recovery"
trigger1 = StateType != A && (Ctrl = 1 || StateNo = 100)
...
triggerall = var(7) != 1      ;Prevents AI from Abusing Charge to throw off AI
trigger1 = ctrl
trigger2 = Time <= 1 && ((StateNo = [200,499]) ||  (StateNo = 700))
;=====================================================================
; Dir + Button
...
type = ChangeState
value = 420
triggerall = Command = "z" && Command = "holddown"; || var(7) != 1
trigger1 = (StateType = C && Ctrl = 1) || StateNo = 100
triggerall = var(7) != 1
trigger1 = ctrl || stateno = 100
trigger2 = stateno = 200 && movecontact
...
type = ChangeState
value = 650
trigger1 = command = "c" && StateType = A && Ctrl = 1
triggerall = var(7) != 1
trigger1 = ctrl || stateno = 100
trigger2 = stateno = 200 && movecontact
trigger3 = stateno = 235 && movecontact
