...
;---------------------------------------------------------------------------
; Assist - Skips
[State -1, Assist - Skips]
type = ChangeState
value = 1000
triggerall = ctrl
triggerall = numhelper(1001) = 0
triggerall = statetype != A
trigger1 = command = "Skips"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Assist - High-Five Ghost
[State -1, Assist - High-Five Ghost]
type = ChangeState
value = 1007
triggerall = ctrl
triggerall = numhelper(1005) = 0
triggerall = statetype != A
trigger1 = command = "High-Five Ghost"
trigger2 = var(7) = 1
trigger2 = random > 999
...
triggerall = numhelper(1012) = 0
triggerall = statetype != A
trigger1 = command = "Tunnel Rat"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Rock 'n' Roll
[State -1, Hyper - Rock 'n' Roll]
type = ChangeState
value = 6000
triggerall = ctrl
triggerall = statetype != A
triggerall = power >= 1000
trigger1 = command = "Rock 'n' Roll"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Rassle Frassle
[State -1, Hyper - Rassle Frassle]
type = ChangeState
value = 6001
triggerall = ctrl
triggerall = statetype != A
triggerall = power >= 1000
trigger1 = command = "Rassle Frassle"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Duck Call
[State -1, Hyper - Duck Call]
type = ChangeState
value = 6004
triggerall = ctrl
triggerall = statetype != A
triggerall = power >= 1000
trigger1 = command = "Duck Call"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Hyper Pendulum
[State -1, Hyper - Hyper Pendulum]
type = ChangeState
value = 6006
triggerall = ctrl
triggerall = statetype != A
triggerall = power >= 2000
trigger1 = command = "Hyper Pendulum"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Hyper Flapper
[State -1, Hyper - Hyper Flapper]
type = ChangeState
value = 6008
triggerall = ctrl
triggerall = statetype != A
triggerall = power >= 2000
trigger1 = command = "Hyper Flapper"
trigger2 = var(7) = 1
trigger2 = random > 979
