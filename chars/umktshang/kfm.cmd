...
[Command]
name = "Dragon"   ;Same name as above
...
[Command]
name = "KneeKick"   ;Same name as above
...
type = ChangeState
value = 3100
triggerall = command = "KFDrillPalm"
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = 200) && time > 40
trigger3 = (stateno = 230) && time > 40
