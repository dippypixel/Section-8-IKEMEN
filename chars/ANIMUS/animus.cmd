...
;cancel cuchillas
trigger3 = numhelper(1110) = 1 
trigger3 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15
trigger4 = numhelper(1130) = 1
trigger4 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15
;cancel giros
trigger5 = (stateno = 1000)||(stateno = 1050)
trigger5 = movecontact && animelemtime(23) < 0
;cancel decoy
trigger6 = stateno = 1210 && movecontact && animelemtime(3)>=2
;safety
trigger7 = (stateno=[200,440]) && time <3
...
;cancel cuchillas
trigger2 = numhelper(1110) = 1 
trigger2 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15
trigger3 = numhelper(1130) = 1 
trigger3 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15
;cancel giros
trigger4 = (stateno = 1000)||(stateno = 1050)
trigger4 = movecontact && animelemtime(23) < 0
;cancel decoy
trigger5 = stateno = 1210 && movecontact && animelemtime(3)>=2
;safety
trigger6 = (stateno=[200,440]) && time <3

;---------------------------------------------------------------------------
;Super lanzas
[State -1, super lanzas]
type = ChangeState
value = 3000
triggerall = command = "superlanzas"
...
;---------------------------------------------------------------------------
;Virgen de hierro
[State -1, virgen de hierro]
type = ChangeState
value = 3100
triggerall = command = "virgen"
triggerall = power >= 1000
triggerall = var(10)=0
triggerall = var(24)=0
trigger1 = statetype = S
...
trigger1 = ctrl
trigger2 = (stateno = 430)||(stateno = 200)||(stateno = 230)
...
triggerall = p2dist x <= 70 && enemynear, pos y <=-40
...
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger2 = movecontact && random < 4
value = cond(random<500,1000,1050)
...
value = cond(random<500,1200,1201)
...
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && p2dist x <= 150 && frontedgedist > 70
trigger1 = ctrl && random < 2
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger2 = movecontact && random < 2
;cancel decoy
trigger3 = stateno = 1210 && movecontact && animelemtime(39) < 0 && random < 5
;cancel giros
trigger4 = (stateno = 1000)||(stateno = 1050)
trigger4 = animelemtime(23) < 0 && movecontact && random < 2
;cancel lanzas
trigger5 = numhelper(1110) = 1
trigger5 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 3
trigger6 = numhelper(1130) = 1
trigger6 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 3
value = 3000
...
type = ChangeState
triggerall = var(24)=4 && roundstate=2 && statetype !=a && power >= 1000
triggerall = var(10) = 0 && P2Dist X <= 160
...
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
trigger1 = ctrl && p2dist x >= 50 && random < 2
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger2 = movecontact && random < 2
;cancel decoy
...
;cancel lanzas
trigger5 = numhelper(1110) = 1
trigger5 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 2
trigger6 = numhelper(1130) = 1
trigger6 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 2
value = 3200
...
;cancel decoy
trigger2 = stateno = 1210 && movecontact && animelemtime(39) < 0 && random < 5
;cancel giros
trigger3 = (stateno = 1000)||(stateno = 1050)
trigger3 = animelemtime(23) < 0 && movecontact && random < 10
value = 3300
...
;cancel giros
trigger4 = (stateno = 1000)||(stateno = 1050)
trigger4 = animelemtime(23) < 0 && movecontact && random < 5
;cancel lanzas
trigger5 = numhelper(1110) = 1 
trigger5 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 5
trigger6 = numhelper(1130) = 1 
trigger6 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 5
value = 3000
...
;cancel giros
trigger3 = (stateno = 1000)||(stateno = 1050)
trigger3 = animelemtime(23) < 0 && movecontact && random < 5
;cancel lanzas
trigger4 = numhelper(1110) = 1 
trigger4 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 5
trigger5 = numhelper(1130) = 1 
trigger5 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 5
value = 3530
...
;p2 ataca
trigger2 = p2dist x <= 100 && ctrl && random < 5 && p2movetype = a
value = cond(random<500,1200,1201)
...
trigger2 = movecontact && random < 10
;cancel decoy
trigger3 = stateno = 1210 && movecontact && animelemtime(39) < 0 && random < 10
;cancel giros
trigger4 = (stateno = 1000)||(stateno = 1050)
trigger4 = animelemtime(23) < 0 && movecontact && random < 10
;cancel lanzas
trigger5 = numhelper(1110) = 1 
trigger5 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 10
trigger6 = numhelper(1130) = 1 
trigger6 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 10
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
...
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
trigger1 = ctrl && p2dist x >= 50 && random < 4
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)
trigger2 = movecontact && random < 10
;cancel decoy
...
;viuda SUPER tela - deja de correr en common
trigger9 = enemynear, name = "ananzi" && enemynear, stateno = 3100 && ctrl && random < 5
value = 3200
...
;cancel decoy
trigger2 = stateno = 1210 && movecontact && animelemtime(39) < 0 && random < 10
;cancel giros
trigger3 = (stateno = 1000)||(stateno = 1050)
trigger3 = animelemtime(23) < 0 && movecontact && random < 10
;cancel lanzas
trigger4 = numhelper(1110) = 1 
trigger4 = helper(1110), movecontact && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 10
trigger5 = numhelper(1130) = 1 
trigger5 = helper(1130), movecontact && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 10
value = 3530
...
;cancel giros
trigger3 = (stateno = 1000)||(stateno = 1050)
trigger3 = animelemtime(23) < 0 && movecontact && random < 30
;CONTRA ATAQUES ESPECIFICOS
;animus virgen
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 70 && enemynear,pos y >-110
...
;En DF
trigger3 = var(10)!=0 && p2dist x <= 130 && ctrl && random <30
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 70 && enemynear,pos y >-130
...
;En DF
trigger3 = var(10)!=0 && p2dist x <= 130 && ctrl && random <20
;CONTRA ATAQUES ESPECIFICOS
;noroko df
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 60 && enemynear,pos y >-90
trigger1 = random <50 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 400)||(stateno = 430)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 90 && enemynear,pos y >-95
trigger1 = random <10 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 400)||(stateno = 430)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 60 && enemynear,pos y >-80
...
;En DF
trigger3 = var(10)!=0 && p2dist x <= 130 && ctrl && random <40
;CONTRA ATAQUES ESPECIFICOS
;noroko df
trigger4 = enemynear, name = "noroko" && enemynear, var(10)!=0 && ctrl && random < 300
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 95 && enemynear,pos y >-95
trigger1 = random <10 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 230)||(stateno = 400)||(stateno = 430)
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a
triggerall = (p2statetype!=L)
triggerall = p2dist x <= 70 && enemynear,pos y >-60
trigger1 = random <80 && ctrl
trigger1 = enemynear, movetype != a
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 230)||(stateno = 400)
...
trigger1 = ctrl && random < 10
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 440)
trigger2 = movehit && random < 120
;CONTRA ATAQUES ESPECIFICOS
;noroko mujer de nieve
trigger3 = enemynear, name = "noroko" && enemynear, stateno = 1210 && ctrl && random < 30
value = 1100
...
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = p2dist x <= 150 && enemynear,pos y >-80
trigger1 = ctrl && random < 7
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)
...
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = var(10) = 0
trigger1 = p2dist x <= 120 && enemynear,pos y >-100 && ctrl && random < 5
;combo chain 1
...
;CONTRA ATAQUES ESPECIFICOS
;noroko mujer de nieve
trigger3 = enemynear, name = "noroko" && enemynear, stateno = 1210 && ctrl && random < 10
;shar-makai df
trigger4 = enemynear, name = "shar-makai" && enemynear, var(10)!=0 && ctrl && random < 50
value = cond(random<500,1200,1201)
...
trigger2 = movehit && random < 50
;cancel decoy
trigger3 = stateno = 1210 && movehit && animelemtime(39) < 0 && random < 5
;cancel giros
trigger4 = (stateno = 1000)||(stateno = 1050)
trigger4 = animelemtime(23) < 0 && movehit && random < 60
trigger4 = (animelem = 7)||(animelem = 13)||(animelem = 19)
;cancel lanzas
trigger5 = numhelper(1110) = 1 
trigger5 = helper(1110), movehit && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 40
trigger6 = numhelper(1130) = 1 
trigger6 = helper(1130), movehit && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 40
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
trigger7 = enemynear, name = "animus" && enemynear, stateno = 1200 && ctrl && random < 7
;noroko df
trigger8 = enemynear, name = "noroko" && enemynear, var(10)!=0 && ctrl && random < 300
;shar-makai df
trigger9 = enemynear, name = "shar-makai" && enemynear, var(10)!=0 && ctrl && random < 300
value = 3000
...
type = ChangeState
triggerall = var(24)=3 && roundstate=2 && statetype !=a && power >= 1000
triggerall = var(10) = 0 && P2Dist X <= 160 && (p2stateno!=[120,155]) && (p2statetype!=L)
trigger1 = ctrl && random <3
;p2 ataca
trigger2 = p2dist x <= 120 && p2dist x >= 70 && ctrl && random < 3 && p2movetype = a
;CONTRA ATAQUES ESPECIFICOS
;noroko mujer de nieve
trigger3 = enemynear, name = "noroko" && enemynear, stateno = 1210 && ctrl && random < 10
value = 3100
...
triggerall = var(24)=3 && roundstate=2 && statetype !=a && power >= 1000
triggerall = var(10) = 0
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L) && enemynear,pos y >-80
trigger1 = ctrl && p2dist x >= 50 && random <7
;combo chain 1
trigger2 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)
trigger2 = movehit && random < 70
;cancel decoy
trigger3 = stateno = 1210 && movehit && animelemtime(39) < 0 && random < 5
;cancel giros
trigger4 = (stateno = 1000)||(stateno = 1050)
...
;viuda SUPER tela - deja de correr en common
trigger9 = enemynear, name = "ananzi" && enemynear, stateno = 3100 && ctrl && random < 10
;noroko df
trigger10 = enemynear, name = "noroko" && enemynear, var(10)!=0 && ctrl && random < 300
;shar-makai df
trigger11 = enemynear, name = "shar-makai" && enemynear, var(10)!=0 && ctrl && random < 300
value = 3200
...
triggerall = var(10) = 0 && life < 500
;combo chain 1
trigger1 = (stateno = 200)||(stateno = 210)||(stateno = 230)||(stateno = 240)||(stateno = 400)||(stateno = 410)||(stateno = 430)||(stateno = 440)
trigger1 = movehit && random < 300
;cancel decoy
trigger2 = stateno = 1210 && movehit && animelemtime(39) < 0 && random < 10
;cancel giros
trigger3 = (stateno = 1000)||(stateno = 1050)
trigger3 = animelemtime(23) < 0 && movehit && random < 30
trigger3 = (animelem = 7)||(animelem = 13)||(animelem = 19)
;cancel lanzas
trigger4 = numhelper(1110) = 1 
trigger4 = helper(1110), movehit && helper(1110), animelemtime(13)<=15 && p2dist x <= 80 && random < 20
trigger5 = numhelper(1130) = 1 
trigger5 = helper(1130), movehit && helper(1130), animelemtime(13)<=15 && p2dist x <= 80 && random < 20
value = 3530
...
trigger1 = movehit && random < 300
;cancel decoy
trigger2 = stateno = 1210 && movehit && animelemtime(39) < 0 && random < 50
;cancel giros
trigger3 = (stateno = 1000)||(stateno = 1050)
trigger3 = animelemtime(23) < 0 && movehit && random < 100
trigger3 = (animelem = 7)||(animelem = 13)||(animelem = 19)
;CONTRA ATAQUES ESPECIFICOS
;animus decoy
